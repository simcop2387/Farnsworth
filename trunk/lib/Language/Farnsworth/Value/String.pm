...
sub subtract
{
  ...
  die "Scalar value given to subtraction to strings" if ($two->isa("Language::Farnsworth::Value::Pari"));
...
sub modulus
{
  ...
  #if there's a higher type, use it, subtraction otherwise doesn't make sense on arrays
  confess "Scalar value given to modulus to string" if ($two->isa("Language::Farnsworth::Value::Pari"));
...
sub mult
{
  ...
  #if there's a higher type, use it, subtraction otherwise doesn't make sense on arrays
  confess "Scalar value given to multiplcation to string" if ($two->isa("Language::Farnsworth::Value::Pari"));
...
sub div
{
  ...
  #if there's a higher type, use it, subtraction otherwise doesn't make sense on arrays
  confess "Scalar value given to division to string" if ($two->isa("Language::Farnsworth::Value::Pari"));
...
sub pow
{
  ...
  #if there's a higher type, use it, subtraction otherwise doesn't make sense on arrays
  confess "Exponentiating strings? what did you think this would do, create a black hole?" if ($two->isa("Language::Farnsworth::Value::Pari"));
